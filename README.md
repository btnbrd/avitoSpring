...
---
# Результаты: были выполнены все необходимые требования(требование по нагрузке не протестировано, расчет на то что проходит за счет постгресс и библиотек), из дополнительных: была добавлена авторизация через почту-пароль, было настроено логирование через zap
